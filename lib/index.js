...
program
    ...
    .requiredOption("-k, --apikey <apiKey>", "API Key (required)")
    .requiredOption("-r, --relationId <relationID>", "Relation ID (required)")
    .requiredOption("--recordId <recordId>", "Relation ID (required)")
    .option("-f, --fileName <fileName>", "The file (required)")
    .option("--public", "indicates if the file is public")
    .action(function (options) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        // inject functionId
        console.log(options);
        (0, node_fetch_1.default)("".concat(options.host, "/.netlify/functions/filestore/").concat(options.relationId).concat(options.recordId ? "/".concat(options.recordId) : ''), {
            method: "POST",
            headers: {
                "X-API-KEY": options.apikey,
                Accept: "application/json",
